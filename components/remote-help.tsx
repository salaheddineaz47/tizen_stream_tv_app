          ...
          <div className="glassmorphism rounded-2xl p-8 max-w-2xl mx-4">
            ...
            <div className="grid grid-cols-2 gap-6 text-sm">
              <div>
                ...
                <ul className="space-y-2 text-muted-foreground">
                  ...
                  <li>
                    <kbd className="bg-muted px-2 py-1 rounded">Home</kbd> Home
                    Screen
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2 text-muted-foreground">
                  <li>
                    <kbd className="bg-muted px-2 py-1 rounded">0-9</kbd> Direct
                    Channel
                  </li>
                  <li>
                    <kbd className="bg-muted px-2 py-1 rounded">Page ↑↓</kbd>{" "}
                    Fast Scroll
                  </li>
                  <li>
            ...
            <div className="mt-6 p-4 bg-primary/10 rounded-lg">
              <p className="text-sm text-muted-foreground">
                <strong>Tip:</strong> Use number keys (1-9) on Live TV page to
                jump directly to channels. Press and hold for 1.5 seconds to
                auto-select.
              </p>
            </div>
          </div>
