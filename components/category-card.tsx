...
export function CategoryCard({
  ...
  return (
    <div
      ref={elementRef}
      className="relative h-80 w-72 rounded-2xl overflow-hidden cursor-pointer group transition-all duration-300 hover:scale-105 focus:scale-105 focus:ring-4 focus:ring-primary/50"
      tabIndex={-1}
    >
      {/* Background Image */}
      {backgroundImage && (
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-white p-6">
        ...
        <h3 className="text-2xl font-bold text-center drop-shadow-lg">{title}</h3>
      </div>
